...
<nav class="navbar navbar-my" role="navigation">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                <li><a href="controller?command=select_language&language=EN&page=path.page.blackList"><span class="bfh-languages" data-language="en_US" data-flags="true"></span>EN</a></li>
                <li><a href="controller?command=select_language&language=RU&page=path.page.blackList"><span class="bfh-languages" data-language="ru_RU" data-flags="true"></span>RU</a></li>
            </ul>
...
<div class="container">
    <div class="i-right-title-text">${nonPayers}</div>
    <table class="table table-bordered">
        ...
        <c:forEach var="order" items="${orderListPurchase}" varStatus="i">
            <tr class="success" align="center">
                ...
                <td>
                    <a href="controller?command=add_black_list&userLogin=${order.createdDate}&orderId=${order.orderId}"
    ...
    <div class="i-right-title-text">${blackListLabel}</div>
    <table class="table table-bordered">
        <thead>
        <tr align="center" class="warning">
            <th>№</th>
